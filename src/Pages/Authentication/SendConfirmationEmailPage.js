    ...
    return (
        <div className="MiddleVerticalAlignContainer VerticalCenterColumn">
            ...
            <div className="MainControlContainer CenterText">
                <button onClick={props.handleSendingEmail} disabled={props.emailSendingState.isExecuting} className="MainButton Font-MainForControls ButtonMarginForColumnWithoutBorders IncreaseButtonHeight">Send confirmation e-mail</button>
            </div>
        </div>
    );
}
